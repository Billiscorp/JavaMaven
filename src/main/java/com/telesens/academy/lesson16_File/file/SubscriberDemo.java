...
public class SubscriberDemo {
    ...
    // TODO
//    private static String path = "/home/billiscorp/Work/Telesens/QA-JA/Java-part-maven/data_Out/";
...
//        OutputStreamWriter osw = new OutputStreamWriter(os);
        ...
        String path = prop.getProperty("pathOut");

        try (FileWriter fw = new FileWriter(path + subscriberFile)) {
