...
import com.telesens.academy.lesson15_Stream.homework15.Subscriber;
...
//                    "INSERT INTO subscriber VALUES("+ subscriber.getId() +"," + subscriber.getAge() + "," + subscriber.getFirstName() + ", + 'm', " +subscriber.getLastName()+")"); // id, age, first_name, gender, last_name
                        "INSERT INTO subscriber VALUES("+ subscriber.getId() +"," + subscriber.getAge() + ",'" + subscriber.getFirstName() + "', + 'm', '" +subscriber.getFirstName()+"')");
